...
/**
 * Chrome (header + footer + persistent rails) for every storefront page.
 *
 * Categories are passed in from the server layout — that way the admin
 * agent can add a category and it appears here without a code change.
 * The static src/lib/categories.ts fallback only kicks in if the DB
 * query fails during build.
 */
...
export function ShopChrome({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-cream">
      ...
      <CategoryRail transparent={transparent} categories={categories} />
